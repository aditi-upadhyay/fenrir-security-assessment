...
const Dashboard: React.FC = () => {
    return (
        <div className="h-full flex flex-col gap-8">
            ...
            <div className="flex-1 bg-white dark:bg-gray-900 rounded-md shadow-[0_2px_8px_-4px_rgba(0,0,0,0.05)] border border-gray-100 dark:border-gray-800 flex flex-col min-h-0 p-6 transition-colors duration-300">
                {/* Header Controls */}
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 shrink-0 mb-6">
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                        <button className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md text-sm font-semibold text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors shadow-sm">
